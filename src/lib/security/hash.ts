 ...
 *
 * This replaces the four separate copies that previously lived inside
 * FileScanner, Scanner, and AISystemGuardian.
 */
...
/** SHA-256 hex digest of a buffer — WebCrypto first, pure JS fallback. */
export async function sha256Hex(buffer: ArrayBuffer): Promise<string> {
  if (typeof globalThis.crypto !== 'undefined' && globalThis.crypto.subtle) {
    try {
      ...
      // Non-secure context or restricted WebView — use the JS implementation.
    }
  }
