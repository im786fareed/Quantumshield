...
/* ── Intake option lists (from the AdamasVault Legal framework) ──
...
`.trim();
  ...
  const downloadCaseFile = () => {
    ...
    const txt = `
╔══════════════════════════════════════════════════════════════╗
║       AdamasVault — MY LEGAL RIGHTS · CASE FILE              ║
╚══════════════════════════════════════════════════════════════╝
Case ID      : ${caseId}
...
Generated by AdamasVault · My Legal Rights (AdamasVault.in)
Ref: ${caseId}
`.trim();
      ...
      <div className="max-w-4xl mx-auto px-4 py-8 md:py-12 pb-20">
        ...
        <div className="space-y-5">
          ...
          <p className="text-center text-[11px] text-gray-600">
            Powered by the AdamasVault Legal Intelligence Engine (AI). Analysis may take up to a minute.
          </p>
        </div>
