...
export default function AppSidebar({ language = 'en' }: { language?: Language }) {
  const activeTab = useNavigationStore((s) => s.activeTab);
  const setTab = useNavigationStore((s) => s.setTab);

  return (
    <aside className="hidden lg:block w-64 border-r border-white/10 bg-black/30 backdrop-blur">
